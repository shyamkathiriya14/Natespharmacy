...
const Footer = () => {
  return (
    <>
      <section id='footer' className='bg-[linear-gradient(97.84deg,#0C1F2B_0%,#00426C_51.91%,#0C212E_100.9%)] p-[76px_16px_0px_16px] sm:p-[76px_30px_0px_30px] xl:p-[76px_76px_0px_76px]'>
        <div className='mb-[45px] sm:mb-[50px] md:mb-[65px] xl:mb-[76px]'>
          ...
          <div className='text-white text-[26px] sm:text-[26px] lg:text-[30px] font-bold mb-[12px]'>NATES PHARMACY</div>
